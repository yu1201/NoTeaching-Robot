...
def main() -> int:
    ...
    for token in (
        ...
        "driver->AbortCurrentProgramSafely()",
    ...
    for token in (
        "motionStatus.state == RobotMotionState::Paused",
        "motionStatus.state == RobotMotionState::Idle",
        "kHandEyeDoneStartupGuardMs",
        "kHandEyeDoneStableSamples",
        "elapsedMs >= kHandEyeDoneStartupGuardMs",
    ...
    for token in (
        ...
        "QPointer<HandEyeCalibrationDialog>",
        "std::thread",
        "driver->RunHandEyeValidation",
        "RobotDriverCapability::HandEyeProgramSupport",
