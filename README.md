...
- 当前源码版本：`v2026.06.10.2247`

建议普通使用者直接从 `Releases` 页面下载安装包 `NoTeaching-Robot-Setup-v2026.06.10.2247.exe`，不用自己编译源码。
...
- 构建验证：`Debug x64`、`Release x64` 和 Inno Setup 打包通过，生成版本化安装包 `NoTeaching-Robot-Setup-v2026.06.10.2247.exe`（101,276,321 bytes，SHA256 `F151CB1C3F88DA7C6675B938227AD572637F9C9B57993904E187866F7BDB58C8`），包内 `BUILD_VERSION.txt` 与应用版本一致
