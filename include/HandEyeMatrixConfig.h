...
// Imported controller matrices carry a controller/source/tool binding. Legacy
// locally calibrated records have no such metadata and continue to use the
// existing local validation. This call is read-only and belongs in pre-motion gates.
