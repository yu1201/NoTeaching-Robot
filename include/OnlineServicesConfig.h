...
namespace OnlineServicesConfig
{
	...
	{
		return ReadValue(QStringLiteral("UpdateBaseUrl"), QStringLiteral("http://156.239.225.105:8090/ota"));
	}
	...
	{
		return ReadValue(QStringLiteral("FtpHost"), QStringLiteral("156.239.225.105"));
	}
